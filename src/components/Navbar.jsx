...
function Navbar() {
  ...
  return (
    <>
      ...
      {/* Mobile Menu - Separate from navbar with spacing */}
      <div className={`lg:hidden fixed top-24 left-0 right-0 z-40 transition-all duration-300 ease-in-out ${
        isMobileMenuOpen 
          ? 'opacity-100 translate-y-0' 
          : 'opacity-0 -translate-y-4 pointer-events-none'
      }`}>
        <div className="container mx-auto px-8">
          <div className="px-6 py-4 space-y-3 bg-gray-900/30 backdrop-blur-sm rounded-xl border border-white/10 shadow-lg">
            <Link
              to="/"
